...
Tags: wowhead, tooltips, shortcode, world of warcraft, wow, classic, wotlk, cata, mop, retail
...
Easily display interactive Wowhead tooltips for WoW items, spells, quests, NPCs, and more using a simple shortcode. Supports multiple game versions and languages.
